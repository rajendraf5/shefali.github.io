            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 mb-4">
                        <div class="sec-title">
                            <p>Categories</p>
                            <div class="title">Working <span>Services</span></div>
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="text">
                            <p>Our design approach is to achieve clean, innovative, timeless design through consideration for detail, sustainability and our client's lifestyle. Our focus is to make interiors places of inspiration and beauty that encourage and enhance the experience and the life that goes on inside them.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-1.jpg')}}" alt="Awesome Image">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="text">
                                        <p>New-construction (start to finish)</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-concept-designs')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-2.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder">
                                <div class="icon-holder">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="text">
                                        <p>Interior renovations & additions</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-project-designs')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-3.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder">
                                <div class="icon-holder">
                                ...
                                <div class="inner">
                                    <h3>Make Overs</h3>
                                    <div class="text">
                                        <p>Space planning & the production of interior drawings for construction</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-make-overs')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-4.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder">
                                <div class="icon-holder">
                                ...
                                <div class="inner">
                                    <h3>Consulting</h3>
                                    <div class="text">
                                        <p>Preparing specification documents for fixtures & finishes</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-consulting')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-5.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder">
                                <div class="icon-holder">
                                ...
                                <div class="inner">
                                    <h3>Glass & Wrought</h3>
                                    <div class="text">
                                        <p>Room by room styling & decor</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-glass-wrought')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/v2-6.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder">
                                <div class="icon-holder">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="text">
                                        <p>Personal home shopping</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="{{URL::to('/ser-space-planning')}}">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/1.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/2.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder bg-white">
                                <div class="inner-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/3.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder bg-white">
                                <div class="inner-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/services/4.jpg')}}" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder bg-white">
                                <div class="inner-content">
                        ...
                        <div class="testimonial-carousel-2 owl-carousel owl-theme">
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="{{asset('assets/images/testimonial/testi-style3-1.png')}}" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                    ...
                                    <div class="text-box">
                                        <p>"crystalo have done an excellent job presenting the analysis & insights. I am confident in saying have helped encounter is to be welcomed and every pain avoided”.</p>
                                    </div>
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="{{asset('assets/images/testimonial/testi-style3-2.png')}}" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                            <h3>H.Sam Danisley</h3>
