    ...
    <!--Start breadcrumb area-->
        ...
        <section class="project-description-area">
            <div class="pattern-bg wow slideInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                <img src="{{asset('assets/images/pattern/project-description-pattern.jpg')}}" alt="Pattern Bg">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-5">
                        <div class="project-description-image-box">
                            <img src="{{asset('assets/images/projects/project-single/project-description-1.jpg')}}" alt="Awesome Image">
                        </div>
                    </div>
                    <div class="col-xl-7">
        ...
        <section class="project-info-area">
            <div class="pattern-bg wow slideInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                <img src="{{asset('assets/images/pattern/project-info-patten.jpg')}}" alt="Pattern Bg">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                    ...
                    <div class="col-xl-6">
                        <div class="project-info-image-box">
                            <img src="{{asset('assets/images/projects/project-single/project-info-1.jpg')}}" alt="Awesome Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="video-holder-box">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/projects/project-single/video-gallery-1.jpg')}}" alt="Awesome Image">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="single-project-image-gallery">
                            <img src="{{asset('assets/images/projects/project-single/image-gallery-1.jpg')}}" alt="Awesome Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/projects/project-single/similar-pro-1.jpg')}}" alt="Awesome Image">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/projects/project-single/similar-pro-2.jpg')}}" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/projects/project-single/similar-pro-3.jpg')}}" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="{{asset('assets/images/projects/project-single/similar-pro-4.jpg')}}" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                                <span>Retreat</span>
