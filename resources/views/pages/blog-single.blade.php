                        ...
                        <div class="single-post-info-content text-center">
                            <div class="meta-box">
                                <ul class="meta-info">
                                    ...
                                    <li>On <a href="#">June 06, 2020</a></li>
                        ...
                        <div class="blog-post">
                            <div class="single-blog-post">
                                <div class="main-image-box">
                                    <img src="{{asset('assets/images/blog/blog-single.jpg')}}" alt="Awesome Image">
                                </div>
                                ...
                                <div class="blog-single-image-with-text-box">
                                    <ul class="image-box clearfix">
                                        <li>
                                            <img src="{{asset('assets/images/blog/blog-single-1.jpg')}}" alt="Awesome Image">
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/images/blog/blog-single-2.jpg')}}" alt="Awesome Image">
                                        </li>
                                    </ul>
                                    <div class="text-box">
                                ...
                                <div class="blog-prev-next-option">
                                    <div class="single prev">
                                        <div class="image-thumb">
                                            <img src="{{asset('assets/images/blog/prev-thumb-1.jpg')}}" alt="Image">
                                            <div class="overlay">
                                                <div class="box">
                                                    <div class="link">
                                    ...
                                    <div class="single next">
                                        <div class="image-thumb">
                                            <img src="{{asset('assets/images/blog/next-thumb-1.jpg')}}" alt="Image">
                                            <div class="overlay">
                                                <div class="box">
                                                    <div class="link">
                            ...
                            <div class="author-box-holder">
                                <div class="inner-box">
                                    <div class="img-box">
                                        <img src="{{asset('assets/images/blog/author.png')}}" alt="Awesome Image">
                                    </div>
                                    <div class="text">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="single-comment-outer-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                            <div class="single-comment-box">
                                                <div class="img-box">
                                                    <img src="{{asset('assets/images/blog/comment-1.png')}}" alt="Awesome Image">
                                                </div>
                                                <div class="text-box">
                                                    <div class="top">
                                                        <div class="name">
                                        ...
                                        <div class="single-comment-outer-box mar-left wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                            <div class="single-comment-box">
                                                <div class="img-box">
                                                    <img src="{{asset('assets/images/blog/comment-2.png')}}" alt="Awesome Image">
                                                </div>
                                                <div class="text-box">
                                                    <div class="top">
                                                        <div class="name">
                                        ...
                                        <div class="single-comment-outer-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                            <div class="single-comment-box">
                                                <div class="img-box">
                                                    <img src="{{asset('assets/images/blog/comment-3.png')}}" alt="Awesome Image">
                                                </div>
                                                <div class="text-box">
                                                    <div class="top">
                                                        <div class="name">
                        ...
                        <div class="sidebar-wrapper">
                                ...
                                <ul class="recent-post">
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/recent-post-1.jpg')}}" alt="Awesome Image">
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/recent-post-2.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-link"></span></a>
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/recent-post-3.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-link"></span></a>
                            ...
                            <div class="single-sidebar">
                                ...
                                <ul class="instagram">
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-1.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-2.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-heart"></span>1k</a>
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-3.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-heart"></span>1k</a>
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-4.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-heart"></span>1k</a>
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-5.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-heart"></span>1k</a>
                                    ...
                                    <li>
                                        <div class="img-holder">
                                            <img src="{{asset('assets/images/sidebar/instagram-6.jpg')}}" alt="Awesome Image">
                                            <div class="overlay-style-one">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="#"><span class="icon-heart"></span>1k</a>
