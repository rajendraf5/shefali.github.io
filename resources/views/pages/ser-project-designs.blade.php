                        ...
                        <div class="single-service-sidebar">
                            ...
                            <div class="single-sidebar">
                                <ul class="service-pages">
                                    <li>
                                        <a href="{{URL::to('/ser-concept-designs')}}">
                                            <div class="title">
                                    ...
                                    <li class="active">
                                        <a href="{{URL::to('/ser-project-designs')}}">
                                            <div class="title">
                                    ...
                                    <li>
                                        <a href="{{URL::to('/ser-glass-wrought')}}">
                                            <div class="title">
                                    ...
                                    <li>
                                        <a href="{{URL::to('/ser-space-planning')}}">
                                            <div class="title">
                            ...
                            <div class="sidebar-contact-box text-center">
                                <div class="inner-content">
                                    ...
                                    <div class="bottom-box">
                                        <h2>+9770318523<br/>+9111321333</h2>
                                        <span>Email: design@shefalisinteriors.com</span>
                                    </div>
                                    <div class="button">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12">
                        <div class="single-service-top">
                            <div class="single-service-image-box">
                                <img src="{{asset('assets/images/services/service-single/single-service-1.jpg')}}" alt="Awesome Image">
                            </div>
                            <div class="text">
                        ...
                        <div class="how-work-box">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="image-box">
                                        <img src="{{asset('assets/images/services/service-single/how-work.jpg')}}" alt="Awesome Image">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="single-pricing-box wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                                            <div class="inner">
                                                <div class="img-box">
                                                    <img src="{{asset('assets/images/services/service-single/pricing-1.jpg')}}" alt="Awesome Image">
                                                </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="single-pricing-box wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                                            <div class="inner">
                                                <div class="img-box">
                                                    <img src="{{asset('assets/images/services/service-single/pricing-2.jpg')}}" alt="Awesome Image">
                                                </div>
                                                <div class="static-content text-center">
                                                    <div class="table-header">
                                                        <div class="top">
                                                ...
                                                <div class="overlay-content">
                                                    ...
                                                    <a class="btn-two" href="{{URL::to('blog')}}">Get Your Pack<span class="flaticon-next"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
